...
//		password.sendKeys(userPassword);
		...
		// select Location
		driver.findElement(By.xpath("//li[@id='"+location+"']")).click();
		screenshot("userLogin");
	...
	public void registerPatient() throws Exception {
		...
		//commonutils.waitForElement(patientName);
		...
		// Split actual address using comma as a delimiter
       String[] actualAddressComponents = actualAdd.split(", ");
       for(String act:actualAddressComponents) {
    	   System.out.println("A:" + act);
       }
//        // Match each component with the expected values
//        String actualAddress = actualAddressComponents[0];
//        String actualCity = actualAddressComponents[1];
//        String actualState = actualAddressComponents[2];
//        String actualCountry = actualAddressComponents[3];
//        String actualZipCode = actualAddressComponents[4];
	...
	public void uploadAttachment() throws Exception {
		...
		//wait for manually uploading the file 
		Thread.sleep(15000);
	...
	public void verifyAttachment() throws Exception {
		...
		Thread.sleep(5000);
		screenshot("After File Attachment");
	...
	public void deletePatient() throws Exception {
		...
		if (!cells.isEmpty()) {
			...
			screenshot("Deleted Patient Details");
